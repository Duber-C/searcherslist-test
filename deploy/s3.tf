##############################################################################
# Media Bucket  (private — served via Django or pre-signed URLs)
##############################################################################
...
##############################################################################
# Static Files Bucket  (public-read — served directly from S3 / CDN)
##############################################################################
...
resource "aws_s3_bucket" "static" {
  ...
  tags = { Name = var.static_bucket_name }
}
...
resource "aws_s3_bucket" "artifacts" {
  ...
  tags = { Name = "${var.project_name}-${var.environment}-pipeline-artifacts" }
}
