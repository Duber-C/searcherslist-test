...
endpoints = [
    ('Individual Endpoint', 'http://localhost:8000/api/update-professional-experience/'),
    ('Section Endpoint', 'http://localhost:8000/api/update-profile/professional-experience/')
]
