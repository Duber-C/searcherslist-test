...
class AIInteractionLog(models.Model):
    ...
    def calculate_cost(self):
        ...
        if self.input_tokens and self.output_tokens:
            ...
            self.input_cost = (self.input_tokens / 1000) * ai_service.input_cost_per_1k_tokens
            self.output_cost = (self.output_tokens / 1000) * ai_service.output_cost_per_1k_tokens
